...
`, 50);
  ...
  function renderProbabilityCoverageLegend() {
    statusBar.innerHTML = `
      <div class="game-coverage-legend probability-coverage-legend">
        <div class="game-coverage-title">Probability</div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-0"></span>
          <span>0.0</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-1"></span>
          <span>&lt; 0.2</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-2"></span>
          <span>0.2 - 0.33</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-3"></span>
          <span>0.33 - 0.4</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-4"></span>
          <span>0.4 - 0.45</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-5"></span>
          <span>0.45 - 0.55</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-6"></span>
          <span>0.55 - 0.75</span>
        </div>
        <div class="game-coverage-item">
          <span class="game-coverage-swatch probability-level-7"></span>
          <span>0.75 - 1.0</span>
        </div>
      </div>
    `;
  ...
  function renderViewLegend() {
    ...
    if (isThresholdMode) {
      renderProbabilityCoverageLegend();
      return;
    }
      ...
      if (isSatisfied) {
        if (isGameMode) {
          ...
          cell.style.backgroundColor = isThresholdMode
            ? getColorFromProbability(probability)
            : hasVariableThresholdMap()
